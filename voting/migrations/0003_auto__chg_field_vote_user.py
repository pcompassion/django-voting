...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('votes', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom_auth.CustomUser']))

    def backwards(self, orm):

        # Changing field 'Vote.user'
        db.alter_column('votes', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'voting.vote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['custom_auth.CustomUser']"}),
